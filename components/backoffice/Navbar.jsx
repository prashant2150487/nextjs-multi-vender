...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between bg-white-800 dark:bg-slate-800 h-20 px-8 py-8 fixed top-0 left-60 right-0 text-green-600 dark:text-green-900">
      <button>
        <AlignJustify />
      </button>
